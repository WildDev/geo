...
public class CaffeineHintsRegistrar implements RuntimeHintsRegistrar {
    ...
    private final static ReflectionMethod COMMON_CONSTRUCTOR = new ReflectionMethod(INIT_METHOD, List.of(
            "com.github.benmanes.caffeine.cache.Caffeine",
            "com.github.benmanes.caffeine.cache.AsyncCacheLoader",
            "boolean"
    ));

    private List<TypeReference> buildTypeReferences(List<String> src) {
    ...
    public void registerHints(@NonNull RuntimeHints runtimeHints, @NonNull ClassLoader classLoader) {
        ...
        addType(hints, "com.github.benmanes.caffeine.cache.CacheLoader",
                "com.github.benmanes.caffeine.cache.Caffeine",
                new ReflectionMethod("asyncLoadAll", List.of("java.util.Set", "java.util.concurrent.Executor")),
                new ReflectionMethod("loadAll", List.of("java.util.Set")));
