...
```cmd
java -jar -Xmx256M target/geo-1.0.0.jar \
    --server.port=8000 \
    --spring.cors.allowed-origins=https://test.website \
    --app.integrations.ipstack.url=https://api.ipstack.com \
    --app.integrations.ipstack.accessKey=723953e7b0e27c762c38213b7c71fd77
```
